defmodule PhoenixAjaxWeb.OrderControllerTest do
  use PhoenixAjaxWeb.ConnCase

  alias PhoenixAjax.Orders
  alias PhoenixAjax.Orders.Order

  @create_attrs %{item: "some item", name: "some name"}
  @update_attrs %{item: "some updated item", name: "some updated name"}
  @invalid_attrs %{item: nil, name: nil}
